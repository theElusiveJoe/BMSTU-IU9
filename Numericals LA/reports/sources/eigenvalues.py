...
# %%
def lin_search(p, a, b, delta = 0.01):
...
def binary_search(p, a, b, delta = 0.0001):
    c = (a+b)/2
    if b-a < delta:
        return c
    if p(c) == 0:
...
# %%
def get_eigenvalues_and_eigenvectors(TestMat, method=DANYLEVSKY):
